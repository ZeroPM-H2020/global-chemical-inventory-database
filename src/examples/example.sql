...
FROM
  ...
  JOIN country_source_index ON country_source_index.source_id = inventories.source_id
  JOIN countries ON country_source_index.country_id = countries.country_id
