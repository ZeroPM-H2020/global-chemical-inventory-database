...
# using Dockerfile from https://github.com/fgregg/datasette/raw/main/Dockerfile
...
# wget https://github.com/fgregg/datasette/raw/main/Dockerfile -O custom-image/Dockerfile
